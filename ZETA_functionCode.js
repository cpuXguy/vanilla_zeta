...
function Test_vanilla_zeta() {
    //────────────────────────────────────────────────────────────────
    //  Test Function - vanilla_zeta()
    //  Purpose:
    //  Demonstrates evaluation of ζ(s) = ζ(input_Real + input_Imag·i)
    //────────────────────────────────────────────────────────────────
    ...
    var input_Imag          = 14.134725141734693   // Imag part:      −Number.MAX_VALUE ≤ input_Imag ≤ Number.MAX_VALUE
    ...
    //────────────────────────────────────────────────────────────────
    //  Results for ζ(s) where s = input_Real + input_Imag·i

    //  output_array[0] →  Real part of ζ(s)
    //  output_array[1] →  Imaginary part of ζ(s)
    //  output_array[2] →  Magnitude |ζ(s)|
    //  output_array[3] →  Argument arg(ζ(s)) in radians  (−π, π]
